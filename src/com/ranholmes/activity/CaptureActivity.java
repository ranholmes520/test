 ...
 * @author Ryan.Tang
 */
public class CaptureActivity extends Activity implements Callback,BMPCActivity{
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if(resultString.equals("")) {
			...
			if(((a[0]=='h'||a[0]=='H')&&(a[1]=='t'||a[1]=='T')) ){
				...
				intent.setClass(CaptureActivity.this,MainUIActivity.class);
				intent.putExtras(bundle);
				startActivity(intent);
			}else{
				Intent resultIntent = new Intent();
//				resultIntent.setClass(CaptureActivity.this, MainUIActivity.class);
//				resultIntent.putExtra("u_id", Integer.parseInt(resultString));
//				//	this.setResult(RESULT_OK, resultIntent);
//				startActivity(resultIntent); 
				
				HashMap<String, Object> mHashMap = new HashMap<String, Object>();
				mHashMap.put("account_o_id", Integer.parseInt(resultString));
				Task t = new Task(Task.SEARCH_ACCOUNT_BY_ID2, mHashMap);
	...
	public void refresh(Object... params) {
		if(params[0].toString().equals("null")){
			...
			Intent intent = new Intent(CaptureActivity.this,AccountListActivity.class);
