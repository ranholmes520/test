	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		for (int i = 0; i < childCount; i++) {
			...
			if (childView.getTag().equals("pieButton")) {
				...
				childView.layout( (int)(  (m_measureWidth -measuredWidth)/2), (int) ((m_measureWidth * 19 / 16))-measureHeight/2,
						 (int)(  (m_measureWidth +measuredWidth)/2),  (int) ((m_measureWidth * 19 / 16))+measureHeight/2);
			} else {
